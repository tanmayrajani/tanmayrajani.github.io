...
$(function() {
	...
	$.getJSON('js/document.json', function(data) {
	    ...
	    var template2 = '<center><h2 class="titlecenter" cellspacing="15px" cellpadding="5px">{{cultural.monday.first.name}}</h2><table class="cult-event"><tr class="trr"><td>Time</td><td>{{cultural.monday.first.time}}</td> </tr><tr class="trr"><td>Place:</td><td>{{cultural.monday.first.place}}</td></tr><tr class="trr"><td>Fees:</td><td>{{cultural.monday.first.fees}}</td></tr><tr class="trr"><td>Co-ordinators:&nbsp;</td><td>{{cultural.monday.first.co-ordinators.c1}}, {{cultural.monday.first.co-ordinators.p1}}<br>{{cultural.monday.first.co-ordinators.c2}}, {{cultural.monday.first.co-ordinators.p2}}</td></tr></table></center><a class="details" href="#monday"><button class="butt3"><< Back</button></a>';
